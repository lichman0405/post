...
type Querier interface {
	...
	CreateAssetDeriveCreation(ctx context.Context, arg CreateAssetDeriveCreationParams) (AssetDeriveCreation, error)
	...
	CreateAssetLineage(ctx context.Context, arg CreateAssetLineageParams) (AssetLineage, error)
	...
	// with.
	GetDeriveParentVersion(ctx context.Context, arg GetDeriveParentVersionParams) (GetDeriveParentVersionRow, error)
	...
	GetDerivedAsset(ctx context.Context, arg GetDerivedAssetParams) (GetDerivedAssetRow, error)
	...
	// a zero value.
	ReviseResearchAssetMetadata(ctx context.Context, arg ReviseResearchAssetMetadataParams) (ResearchAsset, error)
	//
	...
	SearchRankingFacts(ctx context.Context, arg SearchRankingFactsParams) ([]SearchRankingFactsRow, error)
	// ---------------------------------------------------------------------------
	// The graph half.
	//
