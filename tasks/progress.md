...
**T0206 的 Worker 已退出** ✓（RSG Manifest 导出与 hash ✓，无需迁移 ✓），collect 干净、**G2 也已独立复跑全绿** ✓，等 review ✓；T0305 在跑 ✓。
最后更新：2026-09-14 11:40（**五件事**：① **T0304 返工完成** ✓ 并 collect 干净（20 个路径全在 scope）✓；
